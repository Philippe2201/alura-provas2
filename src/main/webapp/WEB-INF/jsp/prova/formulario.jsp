		...
		<div class="container" style="margin-bottom: 100px">
			...
			<div id="questao1" class="clonedInput">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label class="label_enunciado control-label" for="questoes[0].enunciado">Enunciado:</label>
							<textarea class="txt_enunciado form-control" name="questoes[0].enunciado" id="questao[0].enunciado" rows="2"></textarea>
						</div>
					</div>
				</div>
